<template>
  <div class="modal fade" id="terminosCondiciones" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" v-on:click="terminosCondiciones(true)">Acepto</button>
        </div>
      </div>
    </div>
  </div>
  ...
  export default {
    ...
    methods: {
      terminosCondiciones(resultado) {
        this.$emit("terminos_condiciones", {
          terminos_condiciones: resultado
        });
