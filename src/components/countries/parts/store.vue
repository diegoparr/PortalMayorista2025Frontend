        ...
        <div :class="(!errors.first('v_nombre'))?'form-group':'form-group has-error'">
          <div class="form-group">
            ...
            <input name="v_nombre" type="text" class="form-control"
                   ...
                   data-vv-as="nombre del pais" v-model="pais.v_nombre" >
      ...
      methods:{
        ...
        store() {
          this.$validator.validateAll().then(() => {
            ...
            let yo = this;
            this.getAppServices().postMethodWithBearer('api/avanzamas/paises', this.pais, token)
            .then(response => {
