      ...
      <div class="box-header">
        ...
        <h3 class="box-title">
          <v-btn color="info" type="button" v-on:click="crearCategoriaModal" v-show="permisoStore">
            <i class="fa fa-upload  pull-left"></i> Registrar Categoria
          </v-btn>
        </h3>
        </div>
        <div class="col-md-3">
      ...
      <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
          ...
          <template v-else-if="hayCategorias">
            <tr v-for="categoria in pagination.data">
              <td class="text-center">{{categoria.v_nombre}}</td>
              <td v-if="categoria.padre != null" class="text-center">{{categoria.padre.v_nombre}}</td>
              <td v-if="categoria.padre == null" class="text-center">Categoria Principal</td>
              <td class="text-center">
                <v-btn color="info" type="button" v-on:click="btnVerCategoria(categoria)"
                ...
                <v-btn color="primary" type="button" v-show="permisoUpdate"
                        :id="'buttonUpdate'+categoria.id_m_categorias" v-on:click="btnEditarCategoria(categoria)"
                        data-loading-text="&lt;i class='fa fa-spinner fa-spin '&gt;&lt;/i&gt;">
                  <i class="fa fa-pencil"></i>
                </v-btn>
                <v-btn color="error" type="button" v-show="permisoDestroy"
                        :id="'buttonDestroy'+categoria.id_m_categorias" v-on:click="btnBorrarCategoria(categoria)"
                        data-loading-text="&lt;i class='fa fa-spinner fa-spin '&gt;&lt;/i&gt;">
